...
Aa(ej);var ij=null,jj=null,kj=null,lj={};function mj(a){Hg(a.payload_name,a.payload,void 0,void 0)}
function nj(a){var b=a.id;a=a.ve_type;var c=Wg++;a=new Ug({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});lj[b]=a;b=ah();c=$g();b&&c&&dh(b,c,a)}
function oj(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(bh(b,a),a=$g()))for(var c in lj){var d=lj[c];d&&dh(b,a,d)}}
function pj(a){lj[a.id]=new Ug({trackingParams:a.tracking_params})}
function qj(a){var b=ah();a=lj[a.id];b&&a&&Hg("visualElementGestured",{csn:b,ve:Vg(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"})}
function rj(a){a=a.ids;var b=ah();if(b)for(var c=0;c<a.length;c++){var d=lj[a[c]];d&&Hg("visualElementShown",{csn:b,ve:Vg(d),eventType:1})}}
...
u("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);cj(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=Q("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);Q("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&wi(a.args);ij=a=ni(a);a.addEventListener("onScreenChanged",oj);a.addEventListener("onLogClientVeCreated",nj);a.addEventListener("onLogServerVeCreated",pj);a.addEventListener("onLogToGel",mj);
a.addEventListener("onLogVeClicked",qj);a.addEventListener("onLogVesShown",rj);a.addEventListener("onReady",sj);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?kj=new Ii(a):Q("ENABLE_POST_API")&&r(b)&&r(c)&&(jj=new Li(window.parent,b,c),kj=new Ci(a,jj.f));c=R("BG_P");$f(c)&&(Q("BG_I")||Q("BG_IU"))&&(Wf=!0,Vf.initialize(Q("BG_I",null),Q("BG_IU",null),c,Zf));Rf()},void 0);
u("yt.www.watch.ads.restrictioncookie.spr",function(a){ff(a+"mac_204?action_fcts=1");return!0},void 0);
var tj=Je(function(){Yh("ol");var a=ej.getInstance(),b=!!((hj("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&kd(document.body,"exp-invert-logo"))if(c&&!kd(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):kd(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&kd(document.body,"inverted-hdpi")&&ld();b!=c&&(b="f"+(Math.floor(119/31)+1),d=hj(b)||0,d=c?d|67108864:d&-67108865,
0==d?delete Z[b]:Z[b]=d.toString(16).toString(),a.save())}),uj=Je(function(){var a=ij;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Vf.dispose();a=0;for(var b=Pf.length;a<b;a++)Of(Pf[a]);Pf.length=0;If("//static.doubleclick.net/instream/ad_status.js");Qf=!1;P("DCLKSTAT",0);id(kj,jj);if(a=ij)a.removeEventListener("onScreenChanged",oj),a.removeEventListener("onLogClientVeCreated",nj),a.removeEventListener("onLogServerVeCreated",pj),a.removeEventListener("onLogToGel",mj),a.removeEventListener("onLogVeClicked",qj),a.removeEventListener("onLogVesShown",rj),a.removeEventListener("onReady",
sj),a.destroy();lj={}});
window.addEventListener?(window.addEventListener("load",tj),window.addEventListener("unload",uj)):window.attachEvent&&(window.attachEvent("onload",tj),window.attachEvent("onunload",uj));Ja("yt.abuse.player.botguardInitialized",v("yt.abuse.player.botguardInitialized")||ag);Ja("yt.abuse.player.invokeBotguard",v("yt.abuse.player.invokeBotguard")||bg);Ja("yt.abuse.dclkstatus.checkDclkStatus",v("yt.abuse.dclkstatus.checkDclkStatus")||Sf);
