...
定理2：在步骤4.4.4和4.4.5中，每一步的连线都是在该局面状态下的最优方案。

证明：根据该步骤的定义可知。

定理3：在一个子区域中，使用该算法求得的布线总长度能够达到最小。

证明：

定理4：正方形的情况使用该算法一定能够跑出最优解。

证明：



对于长方形而言，若长宽比例过高，则性质1、性质3有可能被破坏，不一定能够达到最优解。TODO：测试性能与误差