...
| $N\times M$         | $d$  | $g_x\times g_y$   | MCMF      | runtime/s  | Network Flow | runtime/s | err       | rate     | Rule      | runtime/s | err       | rate     |
| ------------------- | ---- | ----------------- | --------- | ---------- | ------------ | --------- | --------- | -------- | --------- | --------- | --------- | -------- |
...
对于长方形而言，若长宽比例过高，则性质1、性质3有可能被破坏，不一定能够达到最优解。经过测试，在$\max \{N,M\}\le 100$的时候，所有情况中的绝对误差不超过90，并且在$\min\{N,M\}\ge 20$
